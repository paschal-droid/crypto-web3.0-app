    ...
    <div>
      <nav className='w-full flex md:justify-center justify-between items-center p-4'>
        ...
        <div className='flex relative'>
            ...
            :<HiMenuAlt2 fontSize={28} className='text-white md:hidden cursor-pointer' onClick={()=>setToggle(true)} />
            }
            {toggle && (
              <ul 
                className='z-10 fixed top-0 -right-2 p-3 w-[70vw] h-screen 
                shadow-2xl md:hidden list-none flex flex-col justify-start
              ...
              >
                ...
                {['Market', 'Exchange', 'Tutorials', 'Wallets'].map((item, index) => (
                  <NavbarItem classProps='my-2 text-lg' key={item + index} title={item}  />
                ))}
